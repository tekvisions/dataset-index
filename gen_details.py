...
SITE_URL = "https://dataset.kymatalabs.com"
SITE_NAME = "The Dataset Index"
FONTS = ("https://fonts.googleapis.com/css2?family=Hanken+Grotesk:wght@500;700;800"
...
KSTRIP = ('<div class="kstrip"><div class="wrap">'
          ...
          '</div></div>')
NODE = '<span class="node"><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i></span>'
...
<header><div class="wrap head-row">
  <div class="brand"><a href="/">{NODE}<span class="disp">Dataset <em>Index</em></span></a></div>
  <div class="head-actions"><a href="/">← All tools</a><button class="theme-btn" id="theme" aria-label="Toggle archive / ledger">◐</button></div>
</div></header>
...
<footer><div class="wrap foot-row">
  <div class="blurb">{SITE_NAME} is a self-updating map of the data-centric AI stack, recomputed daily from live GitHub signals. Part of <a href="https://indexes.kymatalabs.com">The Living Indexes</a> by Kymata Labs.</div>
